...
GO
ALTER TABLE [dbo].[Question] DROP CONSTRAINT [FK__Question__Catego__403A8C7D];
...
GO
ALTER TABLE [dbo].[Question] ALTER COLUMN [Category] INT NOT NULL;
...
ALTER TABLE [dbo].[Question] WITH NOCHECK
    ADD FOREIGN KEY ([Category]) REFERENCES [dbo].[Categories] ([ID]);
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Question'))
               AND [type] IN (N'F', N'C')
